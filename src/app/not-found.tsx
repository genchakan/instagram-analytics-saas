...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-bg px-4 text-center">
      ...
      <h1 className="text-2xl font-semibold text-text-primary">{t("legal.pageNotFound")}</h1>
      <p className="max-w-sm text-sm text-text-secondary">{t("legal.pageNotFoundBody")}</p>
      <Button asChild>
