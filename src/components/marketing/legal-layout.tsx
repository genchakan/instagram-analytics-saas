    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          ...
          {updated && <p className="mt-2 text-xs text-text-secondary">Last updated: {updated}</p>}
          <div className="mt-4">
            <Badge variant="warning">Placeholder content — requires professional legal review before production launch</Badge>
          </div>
